...
PostgreQueries = {
    ...
    "add_article": "INSERT INTO OpEdArticle (CategoryId, Link, Title, Description, PublicationTime,KeyWords,Summary) VALUES (%s,%s,%s,%s,%s,%s,%s) ON CONFLICT (Link) DO UPDATE SET Title = excluded.Title,KeyWords=excluded.KeyWords,Summary=excluded.Summary;",  # noqa: E501
...
class OpEdStore:
    def get_categories(self):
        ...
        return [Category(id=row[0], link=row[1], title=row[2], description=row[3]) for row in rows]
